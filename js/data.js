...
const SHL_DATA = {
  ...
  events: [
    {
      ...
      banner: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=1200&h=500&fit=crop',
      price: 149,
      currency: '₹',
      spots: 1000,
      spotsLeft: 234,
    ...
    },
    {
      ...
      banner: 'https://images.unsplash.com/photo-1577962917302-cd874c4e31d2?w=1200&h=500&fit=crop',
      price: 149,
      currency: '₹',
      spots: 600,
      spotsLeft: 89,
    ...
    {
      id: 'evt-004',
      title: 'Baithak — Public Speaking Workshop',
      slug: 'baithak-ps-2026',
      category: 'Workshop',
      description: 'An intensive public speaking and communication skills workshop designed for aspiring leaders and communicators.',
      ...
      banner: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=1200&h=500&fit=crop',
      price: 149,
      currency: '₹',
      spots: 50,
      spotsLeft: 12,
    ...
    },
    {
      ...
      banner: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=500&fit=crop',
      price: 149,
      currency: '₹',
      spots: 100,
      spotsLeft: 43,
    ...
    {
      id: 'evt-006',
      title: 'Singapore Youth Diplomacy Forum',
      slug: 'sydf-2026',
      category: 'Summit',
      description: 'A unique diplomatic forum in Singapore bringing together young diplomats and policy enthusiasts from ASEAN and beyond.',
      longDescription: 'The Singapore Youth Diplomacy Forum is a premier diplomatic event that fosters international cooperation and youth engagement in policy-making across the ASEAN region.',
      date: '2027-01-15',
      endDate: '2027-01-17',
      time: '09:00 AM',
      ...
      banner: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=1200&h=500&fit=crop',
      price: 149,
      currency: '₹',
      spots: 500,
      spotsLeft: 401,
      status: 'upcoming',
      featured: false,
      tags: ['International', 'Diplomacy', 'ASEAN', 'Forum'],
      speakers: [],
      schedule: []
    }
  ],
  ...
  testimonials: [
    ...
    },
    {
      ...
      avatar: 'SC',
      text: 'Coming all the way from Singapore was absolutely worth it. The international networking opportunities and the quality of discussions were unmatched. Can\'t wait for 2026!',
      rating: 5
    }
  ],
  ...
  faqs: [
    {
      ...
      answer: 'Social House Learning (SHL) is an Ed-Tech startup specializing in quality education through progressive learning methods. We organize MUN conferences, youth summits, workshops, and leadership programs across India and internationally.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Absolutely! Our summits in Dubai and Singapore specifically cater to international audiences. We provide visa support letters for registered delegates who need them.'
    }
  ],
